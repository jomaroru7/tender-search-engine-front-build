 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var r2;function k4(){if(r2)return fe;r2=1;var i=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),c=Symbol.for("react.fragment"),d=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),p=Symbol.for("react.consumer"),b=Symbol.for("react.context"),y=Symbol.for("react.forward_ref"),v=Symbol.for("react.suspense"),m=Symbol.for("react.memo"),h=Symbol.for("react.lazy"),_=Symbol.iterator;function A(j){return j===null||typeof j!="object"?null:(j=_&&j[_]||j["@@iterator"],typeof j=="function"?j:null)}var k={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},w=Object.assign,Q={};function U(j,D,I){this.props=j,this.context=D,this.refs=Q,this.updater=I||k}U.prototype.isReactComponent={},U.prototype.setState=function(j,D){if(typeof j!="object"&&typeof j!="function"&&j!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,j,D,"setState")},U.prototype.forceUpdate=function(j){this.updater.enqueueForceUpdate(this,j,"forceUpdate")};function N(){}N.prototype=U.prototype;function B(j,D,I){this.props=j,this.context=D,this.refs=Q,this.updater=I||k}var Z=B.prototype=new N;Z.constructor=B,w(Z,U.prototype),Z.isPureReactComponent=!0;var J=Array.isArray,K={H:null,A:null,T:null,S:null,V:null},ne=Object.prototype.hasOwnProperty;function F(j,D,I,H,re,ce){return I=ce.ref,{$$typeof:i,type:j,key:D,ref:I!==void 0?I:null,props:ce}}function S(j,D){return F(j.type,D,void 0,void 0,void 0,j.props)}function q(j){return typeof j=="object"&&j!==null&&j.$$typeof===i}function L(j){var D={"=":"=0",":":"=2"};return"$"+j.replace(/[=:]/g,function(I){return D[I]})}var W=/\/+/g;function $(j,D){return typeof j=="object"&&j!==null&&j.key!=null?L(""+j.key):D.toString(36)}function le(){}function Me(j){switch(j.status){case"fulfilled":return j.value;case"rejected":throw j.reason;default:switch(typeof j.status=="string"?j.then(le,le):(j.status="pending",j.then(function(D){j.status==="pending"&&(j.status="fulfilled",j.value=D)},function(D){j.status==="pending"&&(j.status="rejected",j.reason=D)})),j.status){case"fulfilled":return j.value;case"rejected":throw j.reason}}throw j}function qe(j,D,I,H,re){var ce=typeof j;(ce==="undefined"||ce==="boolean")&&(j=null);var se=!1;if(j===null)se=!0;else switch(ce){case"bigint":case"string":case"number":se=!0;break;case"object":switch(j.$$typeof){case i:case t:se=!0;break;case h:return se=j._init,qe(se(j._payload),D,I,H,re)}}if(se)return re=re(j),se=H===""?"."+$(j,0):H,J(re)?(I="",se!=null&&(I=se.replace(W,"$&/")+"/"),qe(re,D,I,"",function(ve){return ve})):re!=null&&(q(re)&&(re=S(re,I+(re.key==null||j&&j.key===re.key?"":(""+re.key).replace(W,"$&/")+"/")+se)),D.push(re)),1;se=0;var Ge=H===""?".":H+":";if(J(j))for(var oe=0;oe<j.length;oe++)H=j[oe],ce=Ge+$(H,oe),se+=qe(H,D,I,ce,re);else if(oe=A(j),typeof oe=="function")for(j=oe.call(j),oe=0;!(H=j.next()).done;)H=H.value,ce=Ge+$(H,oe++),se+=qe(H,D,I,ce,re);else if(ce==="object"){if(typeof j.then=="function")return qe(Me(j),D,I,H,re);throw D=String(j),Error("Objects are not valid as a React child (found: "+(D==="[object Object]"?"object with keys {"+Object.keys(j).join(", ")+"}":D)+"). If you meant to render a collection of children, use an array instead.")}return se}function O(j,D,I){if(j==null)return j;var H=[],re=0;return qe(j,H,"","",function(ce){return D.call(I,ce,re++)}),H}function Y(j){if(j._status===-1){var D=j._result;D=D(),D.then(function(I){(j._status===0||j._status===-1)&&(j._status=1,j._result=I)},function(I){(j._status===0||j._status===-1)&&(j._status=2,j._result=I)}),j._status===-1&&(j._status=0,j._result=D)}if(j._status===1)return j._result.default;throw j._result}var ee=typeof reportError=="function"?reportError:function(j){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var D=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof j=="object"&&j!==null&&typeof j.message=="string"?String(j.message):String(j),error:j});if(!window.dispatchEvent(D))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",j);return}console.error(j)};function ae(){}return fe.Children={map:O,forEach:function(j,D,I){O(j,function(){D.apply(this,arguments)},I)},count:function(j){var D=0;return O(j,function(){D++}),D},toArray:function(j){return O(j,function(D){return D})||[]},only:function(j){if(!q(j))throw Error("React.Children.only expected to receive a single React element child.");return j}},fe.Component=U,fe.Fragment=c,fe.Profiler=l,fe.PureComponent=B,fe.StrictMode=d,fe.Suspense=v,fe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=K,fe.__COMPILER_RUNTIME={__proto__:null,c:function(j){return K.H.useMemoCache(j)}},fe.cache=function(j){return function(){return j.apply(null,arguments)}},fe.cloneElement=function(j,D,I){if(j==null)throw Error("The argument must be a React element, but you passed "+j+".");var H=w({},j.props),re=j.key,ce=void 0;if(D!=null)for(se in D.ref!==void 0&&(ce=void 0),D.key!==void 0&&(re=""+D.key),D)!ne.call(D,se)||se==="key"||se==="__self"||se==="__source"||se==="ref"&&D.ref===void 0||(H[se]=D[se]);var se=arguments.length-2;if(se===1)H.children=I;else if(1<se){for(var Ge=Array(se),oe=0;oe<se;oe++)Ge[oe]=arguments[oe+2];H.children=Ge}return F(j.type,re,void 0,void 0,ce,H)},fe.createContext=function(j){return j={$$typeof:b,_currentValue:j,_currentValue2:j,_threadCount:0,Provider:null,Consumer:null},j.Provider=j,j.Consumer={$$typeof:p,_context:j},j},fe.createElement=function(j,D,I){var H,re={},ce=null;if(D!=null)for(H in D.key!==void 0&&(ce=""+D.key),D)ne.call(D,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(re[H]=D[H]);var se=arguments.length-2;if(se===1)re.children=I;else if(1<se){for(var Ge=Array(se),oe=0;oe<se;oe++)Ge[oe]=arguments[oe+2];re.children=Ge}if(j&&j.defaultProps)for(H in se=j.defaultProps,se)re[H]===void 0&&(re[H]=se[H]);return F(j,ce,void 0,void 0,null,re)},fe.createRef=function(){return{current:null}},fe.forwardRef=function(j){return{$$typeof:y,render:j}},fe.isValidElement=q,fe.lazy=function(j){return{$$typeof:h,_payload:{_status:-1,_result:j},_init:Y}},fe.memo=function(j,D){return{$$typeof:m,type:j,compare:D===void 0?null:D}},fe.startTransition=function(j){var D=K.T,I={};K.T=I;try{var H=j(),re=K.S;re!==null&&re(I,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(ae,ee)}catch(ce){ee(ce)}finally{K.T=D}},fe.unstable_useCacheRefresh=function(){return K.H.useCacheRefresh()},fe.use=function(j){return K.H.use(j)},fe.useActionState=function(j,D,I){return K.H.useActionState(j,D,I)},fe.useCallback=function(j,D){return K.H.useCallback(j,D)},fe.useContext=function(j){return K.H.useContext(j)},fe.useDebugValue=function(){},fe.useDeferredValue=function(j,D){return K.H.useDeferredValue(j,D)},fe.useEffect=function(j,D,I){var H=K.H;if(typeof I=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return H.useEffect(j,D)},fe.useId=function(){return K.H.useId()},fe.useImperativeHandle=function(j,D,I){return K.H.useImperativeHandle(j,D,I)},fe.useInsertionEffect=function(j,D){return K.H.useInsertionEffect(j,D)},fe.useLayoutEffect=function(j,D){return K.H.useLayoutEffect(j,D)},fe.useMemo=function(j,D){return K.H.useMemo(j,D)},fe.useOptimistic=function(j,D){return K.H.useOptimistic(j,D)},fe.useReducer=function(j,D,I){return K.H.useReducer(j,D,I)},fe.useRef=function(j){return K.H.useRef(j)},fe.useState=function(j){return K.H.useState(j)},fe.useSyncExternalStore=function(j,D,I){return K.H.useSyncExternalStore(j,D,I)},fe.useTransition=function(){return K.H.useTransition()},fe.version="19.1.0",fe}var n2;function Wo(){return n2||(n2=1,jc.exports=k4()),jc.exports}var C=Wo();const Ce=O2(C);var qc={exports:{}},ms={},xc={exports:{}},Ec={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var i2;function Y4(){return i2||(i2=1,function(i){function t(O,Y){var ee=O.length;O.push(Y);e:for(;0<ee;){var ae=ee-1>>>1,j=O[ae];if(0<l(j,Y))O[ae]=Y,O[ee]=j,ee=ae;else break e}}function c(O){return O.length===0?null:O[0]}function d(O){if(O.length===0)return null;var Y=O[0],ee=O.pop();if(ee!==Y){O[0]=ee;e:for(var ae=0,j=O.length,D=j>>>1;ae<D;){var I=2*(ae+1)-1,H=O[I],re=I+1,ce=O[re];if(0>l(H,ee))re<j&&0>l(ce,H)?(O[ae]=ce,O[re]=ee,ae=re):(O[ae]=H,O[I]=ee,ae=I);else if(re<j&&0>l(ce,ee))O[ae]=ce,O[re]=ee,ae=re;else break e}}return Y}function l(O,Y){var ee=O.sortIndex-Y.sortIndex;return ee!==0?ee:O.id-Y.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;i.unstable_now=function(){return p.now()}}else{var b=Date,y=b.now();i.unstable_now=function(){return b.now()-y}}var v=[],m=[],h=1,_=null,A=3,k=!1,w=!1,Q=!1,U=!1,N=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function J(O){for(var Y=c(m);Y!==null;){if(Y.callback===null)d(m);else if(Y.startTime<=O)d(m),Y.sortIndex=Y.expirationTime,t(v,Y);else break;Y=c(m)}}function K(O){if(Q=!1,J(O),!w)if(c(v)!==null)w=!0,ne||(ne=!0,$());else{var Y=c(m);Y!==null&&qe(K,Y.startTime-O)}}var ne=!1,F=-1,S=5,q=-1;function L(){return U?!0:!(i.unstable_now()-q<S)}function W(){if(U=!1,ne){var O=i.unstable_now();q=O;var Y=!0;try{e:{w=!1,Q&&(Q=!1,B(F),F=-1),k=!0;var ee=A;try{a:{for(J(O),_=c(v);_!==null&&!(_.expirationTime>O&&L());){var ae=_.callback;if(typeof ae=="function"){_.callback=null,A=_.priorityLevel;var j=ae(_.expirationTime<=O);if(O=i.unstable_now(),typeof j=="function"){_.callback=j,J(O),Y=!0;break a}_===c(v)&&d(v),J(O)}else d(v);_=c(v)}if(_!==null)Y=!0;else{var D=c(m);D!==null&&qe(K,D.startTime-O),Y=!1}}break e}finally{_=null,A=ee,k=!1}Y=void 0}}finally{Y?$():ne=!1}}}var $;if(typeof Z=="function")$=function(){Z(W)};else if(typeof MessageChannel<"u"){var le=new MessageChannel,Me=le.port2;le.port1.onmessage=W,$=function(){Me.postMessage(null)}}else $=function(){N(W,0)};function qe(O,Y){F=N(function(){O(i.unstable_now())},Y)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(O){O.callback=null},i.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<O?Math.floor(1e3/O):5},i.unstable_getCurrentPriorityLevel=function(){return A},i.unstable_next=function(O){switch(A){case 1:case 2:case 3:var Y=3;break;default:Y=A}var ee=A;A=Y;try{return O()}finally{A=ee}},i.unstable_requestPaint=function(){U=!0},i.unstable_runWithPriority=function(O,Y){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var ee=A;A=O;try{return Y()}finally{A=ee}},i.unstable_scheduleCallback=function(O,Y,ee){var ae=i.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?ae+ee:ae):ee=ae,O){case 1:var j=-1;break;case 2:j=250;break;case 5:j=1073741823;break;case 4:j=1e4;break;default:j=5e3}return j=ee+j,O={id:h++,callback:Y,priorityLevel:O,startTime:ee,expirationTime:j,sortIndex:-1},ee>ae?(O.sortIndex=ee,t(m,O),c(v)===null&&O===c(m)&&(Q?(B(F),F=-1):Q=!0,qe(K,ee-ae))):(O.sortIndex=j,t(v,O),w||k||(w=!0,ne||(ne=!0,$()))),O},i.unstable_shouldYield=L,i.unstable_wrapCallback=function(O){var Y=A;return function(){var ee=A;A=Y;try{return O.apply(this,arguments)}finally{A=ee}}}}(Ec)),Ec}var s2;function X4(){return s2||(s2=1,xc.exports=Y4()),xc.exports}var Cc={exports:{}},ga={};/**
 * @license React
...
`:"\r"}}function U(S){return S.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function N(S){var q=(S=S||{}).delimiter,L=S.newline,W=S.comments,$=S.step,le=S.preview,Me=S.fastMode,qe=null,O=!1,Y=S.quoteChar==null?'"':S.quoteChar,ee=Y;if(S.escapeChar!==void 0&&(ee=S.escapeChar),(typeof q!="string"||-1<m.BAD_DELIMITERS.indexOf(q))&&(q=","),W===q)throw new Error("Comment character same as delimiter");W===!0?W="#":(typeof W!="string"||-1<m.BAD_DELIMITERS.indexOf(W))&&(W=!1),L!==`
`&&L!=="\r"&&L!==`\r
`&&(L=`
`);var ae=0,j=!1;this.parse=function(D,I,H){if(typeof D!="string")throw new Error("Input must be a string");var re=D.length,ce=q.length,se=L.length,Ge=W.length,oe=F($),ve=[],Ve=[],me=[],Re=ae=0;if(!D)return ia();if(Me||Me!==!1&&D.indexOf(Y)===-1){for(var Ke=D.split(L),we=0;we<Ke.length;we++){if(me=Ke[we],ae+=me.length,we!==Ke.length-1)ae+=L.length;else if(H)return ia();if(!W||me.substring(0,Ge)!==W){if(oe){if(ve=[],Je(me.split(q)),Oa(),j)return ia()}else Je(me.split(q));if(le&&le<=we)return ve=ve.slice(0,le),ia(!0)}}return ia()}for(var ze=D.indexOf(q,ae),be=D.indexOf(L,ae),Le=new RegExp(U(ee)+U(Y),"g"),xe=D.indexOf(Y,ae);;)if(D[ae]===Y)for(xe=ae,ae++;;){if((xe=D.indexOf(Y,xe+1))===-1)return H||Ve.push({type:"Quotes",code:"MissingQuotes",message:"Quoted field unterminated",row:ve.length,index:ae}),Da();if(xe===re-1)return Da(D.substring(ae,xe).replace(Le,Y));if(Y===ee&&D[xe+1]===ee)xe++;else if(Y===ee||xe===0||D[xe-1]!==ee){ze!==-1&&ze<xe+1&&(ze=D.indexOf(q,xe+1));var He=Za((be=be!==-1&&be<xe+1?D.indexOf(L,xe+1):be)===-1?ze:Math.min(ze,be));if(D.substr(xe+1+He,ce)===q){me.push(D.substring(ae,xe).replace(Le,Y)),D[ae=xe+1+He+ce]!==Y&&(xe=D.indexOf(Y,ae)),ze=D.indexOf(q,ae),be=D.indexOf(L,ae);break}if(He=Za(be),D.substring(xe+1+He,xe+1+He+se)===L){if(me.push(D.substring(ae,xe).replace(Le,Y)),Ar(xe+1+He+se),ze=D.indexOf(q,ae),xe=D.indexOf(Y,ae),oe&&(Oa(),j))return ia();if(le&&ve.length>=le)return ia(!0);break}Ve.push({type:"Quotes",code:"InvalidQuotes",message:"Trailing quote on quoted field is malformed",row:ve.length,index:ae}),xe++}}else if(W&&me.length===0&&D.substring(ae,ae+Ge)===W){if(be===-1)return ia();ae=be+se,be=D.indexOf(L,ae),ze=D.indexOf(q,ae)}else if(ze!==-1&&(ze<be||be===-1))me.push(D.substring(ae,ze)),ae=ze+ce,ze=D.indexOf(q,ae);else{if(be===-1)break;if(me.push(D.substring(ae,be)),Ar(be+se),oe&&(Oa(),j))return ia();if(le&&ve.length>=le)return ia(!0)}return Da();function Je(Ye){ve.push(Ye),Re=ae}function Za(Ye){var De=0;return De=Ye!==-1&&(Ye=D.substring(xe+1,Ye))&&Ye.trim()===""?Ye.length:De}function Da(Ye){return H||(Ye===void 0&&(Ye=D.substring(ae)),me.push(Ye),ae=re,Je(me),oe&&Oa()),ia()}function Ar(Ye){ae=Ye,Je(me),me=[],be=D.indexOf(L,ae)}function ia(Ye){if(S.header&&!I&&ve.length&&!O){var De=ve[0],sa=Object.create(null),la=new Set(De);let Es=!1;for(let zr=0;zr<De.length;zr++){let Na=De[zr];if(sa[Na=F(S.transformHeader)?S.transformHeader(Na,zr):Na]){let er,Wr=sa[Na];for(;er=Na+"_"+Wr,Wr++,la.has(er););la.add(er),De[zr]=er,sa[Na]++,Es=!0,(qe=qe===null?{}:qe)[er]=Na}else sa[Na]=1,De[zr]=Na;la.add(Na)}Es&&console.warn("Duplicate headers found and renamed."),O=!0}return{data:ve,errors:Ve,meta:{delimiter:q,linebreak:L,aborted:j,truncated:!!Ye,cursor:Re+(I||0),renamedHeaders:qe}}}function Oa(){$(ia()),ve=[],Ve=[]}},this.abort=function(){j=!0},this.getCharIndex=function(){return ae}}function B(S){var q=S.data,L=y[q.workerId],W=!1;if(q.error)L.userError(q.error,q.file);else if(q.results&&q.results.data){var $={abort:function(){W=!0,Z(q.workerId,{data:[],errors:[],meta:{aborted:!0}})},pause:J,resume:J};if(F(L.userStep)){for(var le=0;le<q.results.data.length&&(L.userStep({data:q.results.data[le],errors:q.results.errors,meta:q.results.meta},$),!W);le++);delete q.results}else F(L.userChunk)&&(L.userChunk(q.results,$,q.file),delete q.results)}q.finished&&!W&&Z(q.workerId,q.results)}function Z(S,q){var L=y[S];F(L.userComplete)&&L.userComplete(q),L.terminate(),delete y[S]}function J(){throw new Error("Not implemented.")}function K(S){if(typeof S!="object"||S===null)return S;var q,L=Array.isArray(S)?[]:{};for(q in S)L[q]=K(S[q]);return L}function ne(S,q){return function(){S.apply(q,arguments)}}function F(S){return typeof S=="function"}return m.parse=function(S,q){var L=(q=q||{}).dynamicTyping||!1;if(F(L)&&(q.dynamicTypingFunction=L,L={}),q.dynamicTyping=L,q.transform=!!F(q.transform)&&q.transform,!q.worker||!m.WORKERS_SUPPORTED)return L=null,m.NODE_STREAM_INPUT,typeof S=="string"?(S=(W=>W.charCodeAt(0)!==65279?W:W.slice(1))(S),L=new(q.download?_:k)(q)):S.readable===!0&&F(S.read)&&F(S.on)?L=new w(q):(d.File&&S instanceof File||S instanceof Object)&&(L=new A(q)),L.stream(S);(L=(()=>{var W;return!!m.WORKERS_SUPPORTED&&(W=(()=>{var $=d.URL||d.webkitURL||null,le=c.toString();return m.BLOB_URL||(m.BLOB_URL=$.createObjectURL(new Blob(["var global = (function() { if (typeof self !== 'undefined') { return self; } if (typeof window !== 'undefined') { return window; } if (typeof global !== 'undefined') { return global; } return {}; })(); global.IS_PAPA_WORKER=true; ","(",le,")();"],{type:"text/javascript"})))})(),(W=new d.Worker(W)).onmessage=B,W.id=v++,y[W.id]=W)})()).userStep=q.step,L.userChunk=q.chunk,L.userComplete=q.complete,L.userError=q.error,q.step=F(q.step),q.chunk=F(q.chunk),q.complete=F(q.complete),q.error=F(q.error),delete q.worker,L.postMessage({input:S,config:q,workerId:L.id})},m.unparse=function(S,q){var L=!1,W=!0,$=",",le=`\r
`,Me='"',qe=Me+Me,O=!1,Y=null,ee=!1,ae=((()=>{if(typeof q=="object"){if(typeof q.delimiter!="string"||m.BAD_DELIMITERS.filter(function(I){return q.delimiter.indexOf(I)!==-1}).length||($=q.delimiter),typeof q.quotes!="boolean"&&typeof q.quotes!="function"&&!Array.isArray(q.quotes)||(L=q.quotes),typeof q.skipEmptyLines!="boolean"&&typeof q.skipEmptyLines!="string"||(O=q.skipEmptyLines),typeof q.newline=="string"&&(le=q.newline),typeof q.quoteChar=="string"&&(Me=q.quoteChar),typeof q.header=="boolean"&&(W=q.header),Array.isArray(q.columns)){if(q.columns.length===0)throw new Error("Option columns is empty");Y=q.columns}q.escapeChar!==void 0&&(qe=q.escapeChar+Me),q.escapeFormulae instanceof RegExp?ee=q.escapeFormulae:typeof q.escapeFormulae=="boolean"&&q.escapeFormulae&&(ee=/^[=+\-@\t\r].*$/)}})(),new RegExp(U(Me),"g"));if(typeof S=="string"&&(S=JSON.parse(S)),Array.isArray(S)){if(!S.length||Array.isArray(S[0]))return j(null,S,O);if(typeof S[0]=="object")return j(Y||Object.keys(S[0]),S,O)}else if(typeof S=="object")return typeof S.data=="string"&&(S.data=JSON.parse(S.data)),Array.isArray(S.data)&&(S.fields||(S.fields=S.meta&&S.meta.fields||Y),S.fields||(S.fields=Array.isArray(S.data[0])?S.fields:typeof S.data[0]=="object"?Object.keys(S.data[0]):[]),Array.isArray(S.data[0])||typeof S.data[0]=="object"||(S.data=[S.data])),j(S.fields||[],S.data||[],O);throw new Error("Unable to serialize unrecognized input");function j(I,H,re){var ce="",se=(typeof I=="string"&&(I=JSON.parse(I)),typeof H=="string"&&(H=JSON.parse(H)),Array.isArray(I)&&0<I.length),Ge=!Array.isArray(H[0]);if(se&&W){for(var oe=0;oe<I.length;oe++)0<oe&&(ce+=$),ce+=D(I[oe],oe);0<H.length&&(ce+=le)}for(var ve=0;ve<H.length;ve++){var Ve=(se?I:H[ve]).length,me=!1,Re=se?Object.keys(H[ve]).length===0:H[ve].length===0;if(re&&!se&&(me=re==="greedy"?H[ve].join("").trim()==="":H[ve].length===1&&H[ve][0].length===0),re==="greedy"&&se){for(var Ke=[],we=0;we<Ve;we++){var ze=Ge?I[we]:we;Ke.push(H[ve][ze])}me=Ke.join("").trim()===""}if(!me){for(var be=0;be<Ve;be++){0<be&&!Re&&(ce+=$);var Le=se&&Ge?I[be]:be;ce+=D(H[ve][Le],be)}ve<H.length-1&&(!re||0<Ve&&!Re)&&(ce+=le)}}return ce}function D(I,H){var re,ce;return I==null?"":I.constructor===Date?JSON.stringify(I).slice(1,25):(ce=!1,ee&&typeof I=="string"&&ee.test(I)&&(I="'"+I,ce=!0),re=I.toString().replace(ae,qe),(ce=ce||L===!0||typeof L=="function"&&L(I,H)||Array.isArray(L)&&L[H]||((se,Ge)=>{for(var oe=0;oe<Ge.length;oe++)if(-1<se.indexOf(Ge[oe]))return!0;return!1})(re,m.BAD_DELIMITERS)||-1<re.indexOf($)||re.charAt(0)===" "||re.charAt(re.length-1)===" ")?Me+re+Me:re)}},m.RECORD_SEP="",m.UNIT_SEP="",m.BYTE_ORDER_MARK="\uFEFF",m.BAD_DELIMITERS=["\r",`
`,'"',m.BYTE_ORDER_MARK],m.WORKERS_SUPPORTED=!p&&!!d.Worker,m.NODE_STREAM_INPUT=1,m.LocalChunkSize=10485760,m.RemoteChunkSize=5242880,m.DefaultDelimiter=",",m.Parser=N,m.ParserHandle=Q,m.NetworkStreamer=_,m.FileStreamer=A,m.StringStreamer=k,m.ReadableStreamStreamer=w,d.jQuery&&((l=d.jQuery).fn.parse=function(S){var q=S.config||{},L=[];return this.each(function(le){if(!(l(this).prop("tagName").toUpperCase()==="INPUT"&&l(this).attr("type").toLowerCase()==="file"&&d.FileReader)||!this.files||this.files.length===0)return!0;for(var Me=0;Me<this.files.length;Me++)L.push({file:this.files[Me],inputElem:this,instanceConfig:l.extend({},q)})}),W(),this;function W(){if(L.length===0)F(S.complete)&&S.complete();else{var le,Me,qe,O,Y=L[0];if(F(S.before)){var ee=S.before(Y.file,Y.inputElem);if(typeof ee=="object"){if(ee.action==="abort")return le="AbortError",Me=Y.file,qe=Y.inputElem,O=ee.reason,void(F(S.error)&&S.error({name:le},Me,qe,O));if(ee.action==="skip")return void $();typeof ee.config=="object"&&(Y.instanceConfig=l.extend(Y.instanceConfig,ee.config))}else if(ee==="skip")return void $()}var ae=Y.instanceConfig.complete;Y.instanceConfig.complete=function(j){F(ae)&&ae(j,Y.file,Y.inputElem),$()},m.parse(Y.file,Y.instanceConfig)}}function $(){L.splice(0,1),W()}}),b&&(d.onmessage=function(S){S=S.data,m.WORKER_ID===void 0&&S&&(m.WORKER_ID=S.workerId),typeof S.input=="string"?d.postMessage({workerId:m.WORKER_ID,results:m.parse(S.input,S.config),finished:!0}):(d.File&&S.input instanceof File||S.input instanceof Object)&&(S=m.parse(S.input,S.config))&&d.postMessage({workerId:m.WORKER_ID,results:S,finished:!0})}),(_.prototype=Object.create(h.prototype)).constructor=_,(A.prototype=Object.create(h.prototype)).constructor=A,(k.prototype=Object.create(k.prototype)).constructor=k,(w.prototype=Object.create(h.prototype)).constructor=w,m})}(Yo)),Yo.exports}var ab=eb();const rb=O2(ab),nb=`03000000;Productos de la agricultura, ganadería, pesca, silvicultura y productos afines\r
...
`;rb.parse(nb,{header:!1,delimiter:";",skipEmptyLines:!0,complete:i=>{const t=Object.fromEntries(i.data);A3.dispatch($v(t))}});const ib=document.getElementById("root"),sb=I4.createRoot(ib);sb.render(g.jsx(C.StrictMode,{children:g.jsx(Hf,{store:A3,children:g.jsx(Iv,{})})}));
