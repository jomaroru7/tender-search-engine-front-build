 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var e2;function V4(){return e2||(e2=1,function(i){function t(N,X){var ee=N.length;N.push(X);e:for(;0<ee;){var re=ee-1>>>1,q=N[re];if(0<l(q,X))N[re]=X,N[ee]=q,ee=re;else break e}}function c(N){return N.length===0?null:N[0]}function d(N){if(N.length===0)return null;var X=N[0],ee=N.pop();if(ee!==X){N[0]=ee;e:for(var re=0,q=N.length,D=q>>>1;re<D;){var I=2*(re+1)-1,H=N[I],ne=I+1,ce=N[ne];if(0>l(H,ee))ne<q&&0>l(ce,H)?(N[re]=ce,N[ne]=ee,re=ne):(N[re]=H,N[I]=ee,re=I);else if(ne<q&&0>l(ce,ee))N[re]=ce,N[ne]=ee,re=ne;else break e}}return X}function l(N,X){var ee=N.sortIndex-X.sortIndex;return ee!==0?ee:N.id-X.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var p=performance;i.unstable_now=function(){return p.now()}}else{var b=Date,g=b.now();i.unstable_now=function(){return b.now()-g}}var v=[],m=[],y=1,_=null,A=3,k=!1,w=!1,Y=!1,G=!1,O=typeof setTimeout=="function"?setTimeout:null,B=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function J(N){for(var X=c(m);X!==null;){if(X.callback===null)d(m);else if(X.startTime<=N)d(m),X.sortIndex=X.expirationTime,t(v,X);else break;X=c(m)}}function K(N){if(Y=!1,J(N),!w)if(c(v)!==null)w=!0,ae||(ae=!0,$());else{var X=c(m);X!==null&&je(K,X.startTime-N)}}var ae=!1,F=-1,j=5,T=-1;function L(){return G?!0:!(i.unstable_now()-T<j)}function W(){if(G=!1,ae){var N=i.unstable_now();T=N;var X=!0;try{e:{w=!1,Y&&(Y=!1,B(F),F=-1),k=!0;var ee=A;try{a:{for(J(N),_=c(v);_!==null&&!(_.expirationTime>N&&L());){var re=_.callback;if(typeof re=="function"){_.callback=null,A=_.priorityLevel;var q=re(_.expirationTime<=N);if(N=i.unstable_now(),typeof q=="function"){_.callback=q,J(N),X=!0;break a}_===c(v)&&d(v),J(N)}else d(v);_=c(v)}if(_!==null)X=!0;else{var D=c(m);D!==null&&je(K,D.startTime-N),X=!1}}break e}finally{_=null,A=ee,k=!1}X=void 0}}finally{X?$():ae=!1}}}var $;if(typeof Z=="function")$=function(){Z(W)};else if(typeof MessageChannel<"u"){var le=new MessageChannel,Me=le.port2;le.port1.onmessage=W,$=function(){Me.postMessage(null)}}else $=function(){O(W,0)};function je(N,X){F=O(function(){N(i.unstable_now())},X)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(N){N.callback=null},i.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<N?Math.floor(1e3/N):5},i.unstable_getCurrentPriorityLevel=function(){return A},i.unstable_next=function(N){switch(A){case 1:case 2:case 3:var X=3;break;default:X=A}var ee=A;A=X;try{return N()}finally{A=ee}},i.unstable_requestPaint=function(){G=!0},i.unstable_runWithPriority=function(N,X){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var ee=A;A=N;try{return X()}finally{A=ee}},i.unstable_scheduleCallback=function(N,X,ee){var re=i.unstable_now();switch(typeof ee=="object"&&ee!==null?(ee=ee.delay,ee=typeof ee=="number"&&0<ee?re+ee:re):ee=re,N){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=ee+q,N={id:y++,callback:X,priorityLevel:N,startTime:ee,expirationTime:q,sortIndex:-1},ee>re?(N.sortIndex=ee,t(m,N),c(v)===null&&N===c(m)&&(Y?(B(F),F=-1):Y=!0,je(K,ee-re))):(N.sortIndex=q,t(v,N),w||k||(w=!0,ae||(ae=!0,$()))),N},i.unstable_shouldYield=L,i.unstable_wrapCallback=function(N){var X=A;return function(){var ee=A;A=X;try{return N.apply(this,arguments)}finally{A=ee}}}}(xc)),xc}var a2;function k4(){return a2||(a2=1,qc.exports=V4()),qc.exports}var Ec={exports:{}},ga={};/**
 * @license React
...
`,'"',m.BYTE_ORDER_MARK],m.WORKERS_SUPPORTED=!p&&!!d.Worker,m.NODE_STREAM_INPUT=1,m.LocalChunkSize=10485760,m.RemoteChunkSize=5242880,m.DefaultDelimiter=",",m.Parser=O,m.ParserHandle=Y,m.NetworkStreamer=_,m.FileStreamer=A,m.StringStreamer=k,m.ReadableStreamStreamer=w,d.jQuery&&((l=d.jQuery).fn.parse=function(j){var T=j.config||{},L=[];return this.each(function(le){if(!(l(this).prop("tagName").toUpperCase()==="INPUT"&&l(this).attr("type").toLowerCase()==="file"&&d.FileReader)||!this.files||this.files.length===0)return!0;for(var Me=0;Me<this.files.length;Me++)L.push({file:this.files[Me],inputElem:this,instanceConfig:l.extend({},T)})}),W(),this;function W(){if(L.length===0)F(j.complete)&&j.complete();else{var le,Me,je,N,X=L[0];if(F(j.before)){var ee=j.before(X.file,X.inputElem);if(typeof ee=="object"){if(ee.action==="abort")return le="AbortError",Me=X.file,je=X.inputElem,N=ee.reason,void(F(j.error)&&j.error({name:le},Me,je,N));if(ee.action==="skip")return void $();typeof ee.config=="object"&&(X.instanceConfig=l.extend(X.instanceConfig,ee.config))}else if(ee==="skip")return void $()}var re=X.instanceConfig.complete;X.instanceConfig.complete=function(q){F(re)&&re(q,X.file,X.inputElem),$()},m.parse(X.file,X.instanceConfig)}}function $(){L.splice(0,1),W()}}),b&&(d.onmessage=function(j){j=j.data,m.WORKER_ID===void 0&&j&&(m.WORKER_ID=j.workerId),typeof j.input=="string"?d.postMessage({workerId:m.WORKER_ID,results:m.parse(j.input,j.config),finished:!0}):(d.File&&j.input instanceof File||j.input instanceof Object)&&(j=m.parse(j.input,j.config))&&d.postMessage({workerId:m.WORKER_ID,results:j,finished:!0})}),(_.prototype=Object.create(y.prototype)).constructor=_,(A.prototype=Object.create(y.prototype)).constructor=A,(k.prototype=Object.create(k.prototype)).constructor=k,(w.prototype=Object.create(y.prototype)).constructor=w,m})}(Yo)),Yo.exports}var Fv=Iv();const $v=P2(Fv),Wv=`03000000;Productos de la agricultura, ganadería, pesca, silvicultura y productos afines\r
...
`;$v.parse(Wv,{header:!1,delimiter:";",skipEmptyLines:!0,complete:i=>{const t=Object.fromEntries(i.data);E3.dispatch(Kv(t))}});const eb=document.getElementById("root"),ab=K4.createRoot(eb);ab.render(h.jsx(C.StrictMode,{children:h.jsx(Bf,{store:E3,children:h.jsx(Qv,{})})}));
