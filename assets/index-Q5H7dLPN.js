...
`;eb.parse(ab,{header:!1,delimiter:";",skipEmptyLines:!0,complete:i=>{const t=Object.fromEntries(i.data);E3.dispatch(I5(t))}});const rb=document.getElementById("root"),nb=K4.createRoot(rb);nb.render(g.jsx(A.StrictMode,{children:g.jsx(Bf,{store:E3,children:g.jsx(K5,{})})}));
